...
public class LineView extends View {
    ...
    private int topLineLength = MyUtils.dip2px(getContext(), 12);; // 12
                                                                   //-+-+-
    private int sideLineLength = MyUtils.dip2px(getContext(),45)/3*2;// *2
    private int backgroundGridWidth =Constants.width/20;//45
    ...
    private final int BOTTOM_TEXT_COLOR = Color.parseColor("#ffffff");
 ...
 //   private String[] colorArray = {"#e74c3c","#2980b9","#1abc9c"};
    ...
    private int[] popupColorArray = {R.drawable.popup_blue,R.drawable.popup_blue,R.drawable.popup_green};
        ...
        if(dataLists != null && !dataLists.isEmpty()){
        	...
        	for(int k = 0; k < dataLists.size(); k++){
        		...
        		for(int i=0;i<dataLists.get(k).size();i++){
                    ...
                    if(i>drawDotSize-1){
                    	//锟斤拷锟斤拷锟介附��锟斤拷���锟介附��� ��硷拷��э拷锟斤拷锟斤拷锟斤拷.
                        drawDotLists.get(k).add(new Dot(x, 0, x, y, dataLists.get(k).get(i),k));
                    }else{
                    	//锟斤拷锟斤拷锟介附��锟斤拷���锟借�筹拷锟� 锟斤拷锟界�达拷锟斤拷锟� 锟斤拷���锟斤拷锟斤拷锟斤拷锟斤拷.
...
// 锟斤拷锟斤拷锟斤拷锟斤拷锟� dot 姣碉拷 popup 锟斤拷锟� 锟斤拷锟界�达拷 锟斤拷锟斤拷锟斤拷.        
    ...
    private void drawLines(Canvas canvas){
     ...
     private void drawBackgroundLines(Canvas canvas){
        ...
        //draw vertical lines
//        for(int i=0;i<xCoordinateList.size();i++){//x坐标
...
//      for(int i=0;i<yCoordinateList.size();i++){//y坐标
