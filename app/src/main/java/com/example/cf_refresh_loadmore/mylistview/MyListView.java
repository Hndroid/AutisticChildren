package com.example.cf_refresh_loadmore.mylistview;
...
public class MyListView extends ListView implements OnScrollListener {
	...
	public void startRefresh() {
		...
		if (!cIsPullRefreshing) {
			...
			cMyListViewHeader.setState(cMyListViewHeader.STATE_REFRESHING);
			// 刷新、加载接口不为空
			if (cMyListViewListener != null) {
				// 根据cLoadID刷新
...
//		cMyListViewHeader.cTextViewTime.setText(getSystemTime());
		cMyListViewHeader.cTextViewTime.setText("小桔智能喂食器");
	}
